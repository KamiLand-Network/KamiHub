...
public class MessageUtil {
     ...
     */
    public static Component getMessage(@NotNull String miniMessage, String... replacements) {
     ...
     */
    public static Component getMessage(@Nullable Player player, @NotNull String miniMessage, String... replacements) {
